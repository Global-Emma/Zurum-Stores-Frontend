...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path='/users' element={<Users cart={cart} API_URL={API_URL} token={token} details={details} login={isLoggedIn} />} />
      ...
      <Route path='/payment-failure' element={<div id='msg-body'><h1 id='msg-txt' style={{color: 'green'}} >Payment Failed</h1><p>Unfortunately, your payment could not be processed. Please try again.</p><button id="msg-btn" onClick={() => window.location.href = '/cart'}>Return to Cart</button></div>} />
